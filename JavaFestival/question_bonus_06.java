...
public class question_bonus_06 {
    public static void main(String[] args) {
        ...
        System.out.println("결과 확인[재귀 사용] : " + CalculatePower(base, n));
        System.out.println("결과 확인[For 사용] : " + calculatePowerForFunc(base, n));
    }
    ...
    private static int calculatePowerForFunc(int num, int power) {
        int answer = 1;
        if (num > 0 && power == 0) {
            return answer;
